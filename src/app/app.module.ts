...
import { BusquedaDePaquetesTuristicosComponent } from './components/busqueda-de-paquetes-turisticos/busqueda-de-paquetes-turisticos.component';
...
@NgModule({
  declarations: [
    ...
    HomeComponent,
    FooterComponent,
    BusquedaDePaquetesTuristicosComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule
